            ...
            <div class="col-md-3 border-end">
                <div class="p-4">
                    <div class="d-flex align-items-center mb-4">
                        <img src="<?= isset($user['avatar']) ? '/gym/public' . $user['avatar'] : 'https://placehold.co/100x100?text=Profile' ?>"
                        ...
                        <div>
                            ...
                            <small class="text-muted">
                                ...
                                <a href="/gym/user/profile" class="text-decoration-none text-muted">Sửa hồ
                                    sơ</a>
                            </small>
                        </div>
                    </div>
